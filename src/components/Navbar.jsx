  ...
  return (
    <div className='mt-6 flex align-center'>
        ...
        <div className='ml-auto border-r border-1 '>
          <select onChange={(e)=>setFontFamily(e.target.value)} className={`appearance-none focus:outline-none text-center bg-gray bg-transparent  mr-4 border-none hover:shadow-xl`}>
